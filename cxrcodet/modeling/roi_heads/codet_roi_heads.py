...
from .codet_fast_rcnn import CoDetFastRCNNOutputLayers
...
class CoDetCascadeROIHeads(CascadeROIHeads):
    @configurable
    def __init__(
            self,
            *,
    ...
    def _forward_box(self, features, proposals, targets=None,
            ...
            if k > 0:
                ...
                if self.training and ann_type in ['box']:
                    proposals = self._match_and_label_boxes(
                        proposals, k, targets)
            predictions = self._run_stage(features, proposals, k, ann_type=ann_type,
        ...
        if self.training:
            ...
            for stage, (predictor, predictions, proposals) in enumerate(head_outputs):
                ...
                # print(f"prev_pred_boxes:{prev_pred_boxes}")
    ...
    def forward(self, images, features, proposals, targets=None,
        ...
        if self.training:
            ...
            losses = self._forward_box(features, proposals, targets, ann_type=ann_type, classifier_info=classifier_info)
            ...
            # debug_second_stage(images, targets, proposals=proposals, vis_thresh=0.5,
            #                    save_debug=True, debug_show_name=True, image_labels=[],
    ...
    def _run_stage(self, features, proposals, stage, \
                   ann_type, classifier_info=(None, None, None)):
        """
        ...
        return self.box_predictor[stage](
            box_features, ann_type=ann_type,
            classifier_info=classifier_info)
